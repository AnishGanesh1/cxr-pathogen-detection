...
RESUME_FROM = "checkpoints_mimic/best_p14_model.pth"
SAVE_BEST   = "checkpoints_mimic/best_p13_model.pth"
CKPT_DIR    = "checkpoints_mimic"

PATIENT_PREFIX = "13"   # filters only p13 patients
BATCH_SIZE     = 32
EPOCHS         = 10
LR             = 0.001
NUM_CLASSES    = 14
...
if os.path.exists(RESUME_FROM):
    ...
    print("✅ Loaded p14 knowledge successfully!\n")
else:
...
# Find a sample image for p13 (data is in ROOT_DIR/p13)
