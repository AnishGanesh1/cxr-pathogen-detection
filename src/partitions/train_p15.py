...
SAVE_BEST   = "checkpoints_mimic/best_p15_model.pth"
CKPT_DIR    = "checkpoints_mimic"

PATIENT_PREFIX = "15"   # filters only p15 patients
BATCH_SIZE     = 32
EPOCHS         = 10
LR             = 0.001
NUM_CLASSES    = 14
...
if os.path.exists(RESUME_FROM):
    ...
    print("✅ Loaded p13 knowledge successfully!\n")
else:
...
# Find a sample image for p15 (data is in ROOT_DIR/p15)
